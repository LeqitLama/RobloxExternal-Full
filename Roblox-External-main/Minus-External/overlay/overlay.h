...
public:
    ...
    void DrawPlayerCount(int player_count);
    
    float GetFPS() const { return current_fps; }
    ImFont* GetMinecraftFont() const { return minecraft_font; }

    bool menu_open = true;
    void ToggleMenu() { menu_open = !menu_open; }
